...
# ./jobs/topd_tuning/primer.sh surgical 100 10 0.25 1.0 accuracy $criterion 3 1440 short
...
# ./jobs/topd_tuning/primer.sh bank_marketing 100 10 0.25 1.0 roc_auc $criterion 3 1440 short
...
# ./jobs/topd_tuning/primer.sh credit_card 250 20 0.25 1.0 average_precision $criterion 9 1440 short
# ./jobs/topd_tuning/primer.sh synthetic 250 20 0.25 0.5 accuracy $criterion 30 1440 short
