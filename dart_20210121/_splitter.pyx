...
cdef class _Splitter:
    ...
    cdef void split_node(self,
        ...
        # random, create a node based on "Extremely Randomized Trees" (using k=1)
        # Reference: https://link.springer.com/article/10.1007/s10994-006-6226-1
        # Choose (k=1) features at random, then pick a threshold uniformly at
        # random between the min. and max. values of that feature
        # TODO: make sure the feature is not constant? Probably. Check SKLearn.
        else:
