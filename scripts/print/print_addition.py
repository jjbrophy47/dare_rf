"""
Print results of addition experiment for a single dataset.
"""
import os
import argparse
...
def print_dataset(args, dataset, logger):
    ...
    for adversary in args.adversary:
        ...
        exact_additions, _ = print_util.get_mean_completions(args, exact, n_trees)
        ...
        logger.info(s.format(exact_train, exact_additions, exact_amortize,
        ...
        for epsilon in args.epsilon:
            ...
            logger.info(s.format(cedar_train, cedar_additions, cedar_amortize, cedar_speedup,
