...
def main(args):
    ...
    fig, axs = plt.subplots(2, 1, figsize=(width, height * 1.5), sharex=True)
    ...
    leg = axs[0].legend(labels=labels, ncol=3, framealpha=1.0, loc='upper center')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', type=str, default='output/plots/update_bar_B/', help='output directory.')
