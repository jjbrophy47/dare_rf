 ...
 *         cdef int  chosen_ndx
 */
  __pyx_v_valid_indices = NULL;

  /* "cedar/_splitter.pyx":58
 *         cdef int* valid_features = NULL
 *         cdef int* valid_indices = NULL
 *         cdef int  valid_features_count = 0             # <<<<<<<<<<<<<<
 *         cdef int  chosen_ndx
 ...
 *                 j = 0
 */
      __pyx_v_split->left_features = ((int *)malloc((__pyx_v_split->features_count * (sizeof(int)))));
 ...
 */
      __pyx_v_split->right_features = ((int *)malloc((__pyx_v_split->features_count * (sizeof(int)))));
 ...
 *                         j += 1
 */
          (__pyx_v_split->left_features[__pyx_v_j]) = (__pyx_v_node->features[__pyx_v_i]);
 ...
 * 
 */
          (__pyx_v_split->right_features[__pyx_v_j]) = (__pyx_v_node->features[__pyx_v_i]);
...
static PyObject *__pyx_pf_5cedar_9_splitter_9_Splitter_16min_samples_leaf___get__(struct __pyx_obj_5cedar_9_splitter__Splitter *__pyx_v_self) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_self->min_samples_leaf); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 33, __pyx_L1_error)
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_5cedar_5_tree__TreeBuilder = __Pyx_ImportType(__pyx_t_1, "cedar._tree", "_TreeBuilder", sizeof(struct __pyx_obj_5cedar_5_tree__TreeBuilder), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5cedar_5_tree__TreeBuilder) __PYX_ERR(6, 56, __pyx_L1_error)
  __pyx_vtabptr_5cedar_5_tree__TreeBuilder = (struct __pyx_vtabstruct_5cedar_5_tree__TreeBuilder*)__Pyx_GetVtable(__pyx_ptype_5cedar_5_tree__TreeBuilder->tp_dict); if (unlikely(!__pyx_vtabptr_5cedar_5_tree__TreeBuilder)) __PYX_ERR(6, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
