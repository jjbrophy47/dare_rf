...
Also, the top d layers are the only non-random layers, all other layers
are random and can support an unlimited number of deletions.
"""
import numbers
...
class Forest(object):
    ...
    epsilon: float (default=0.1)
        Controls the level of indistinguishability; lower for stricter guarantees,
    ...
    verbose: int (default=0)
        Verbosity level.
    """
    def __init__(self, epsilon=1.0, lmbda=0.1, topd=1, n_estimators=100, max_features='sqrt',
                 max_depth=10, criterion='gini', atol=1e-7, min_samples_split=2, min_samples_leaf=1,
...
class Tree(object):
    ...
    verbose: int (default=0)
        Verbosity level.
    """
    def __init__(self, epsilon=1.0, lmbda=0.1, topd=1, max_depth=4, criterion='gini',
                 atol=1e-7, min_samples_split=2, min_samples_leaf=1, random_state=None,
                 verbose=0):
        self.epsilon = epsilon
        self.lmbda = lmbda
        self.topd = topd
