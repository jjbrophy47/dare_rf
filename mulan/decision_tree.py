"""
GBDT implementation using CART regression trees. MSE is used to find the best split attribute and value
as this is equivalent to finding the maximum variance reduction.
Adapted from MLFromScratch: https://github.com/eriklindernoren/ML-From-Scratch/blob/master/mlfromscratch/supervised_learning/decision_tree.py
"""
